...
class Ui_MainWindow:
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", "fuscan \u901a\u7528\u6587\u4ef6\u626b\u63cf\u5668", None))
...
#endif // QT_CONFIG(shortcut)
        self.select_path_action.setText(QCoreApplication.translate("MainWindow", "\u9009\u62e9\u626b\u63cf\u8def\u5f84...", None))
        ...
        self.scan_mode_combo.setItemText(2, QCoreApplication.translate("MainWindow", "\u9009\u62e9\u6587\u4ef6\u5939", None))

#if QT_CONFIG(tooltip)
        self.scan_mode_combo.setToolTip(QCoreApplication.translate("MainWindow", "\u9009\u62e9\u626b\u63cf\u6a21\u5f0f", None))
#endif // QT_CONFIG(tooltip)
        self.full_scan_label.setText(QCoreApplication.translate("MainWindow", "\u5c06\u626b\u63cf\u6240\u6709\u76d8\u7b26", None))
#if QT_CONFIG(tooltip)
        self.path_combo.setToolTip(QCoreApplication.translate("MainWindow", "\u626b\u63cf\u8def\u5f84\uff08\u53ef\u4ece\u5386\u53f2\u8bb0\u5f55\u4e2d\u9009\u62e9\uff09", None))
#endif // QT_CONFIG(tooltip)
        self.select_path_btn.setText(QCoreApplication.translate("MainWindow", "\u9009\u62e9...", None))
#if QT_CONFIG(tooltip)
        self.view_results_btn.setToolTip(QCoreApplication.translate("MainWindow", "\u67e5\u770b\u4e0a\u6b21\u626b\u63cf\u7ed3\u679c", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.skipped_dirs_group.setTitle(QCoreApplication.translate("MainWindow", "\u8df3\u8fc7\u7684\u6587\u4ef6\u5939", None))
        self.matched_files_group.setTitle(QCoreApplication.translate("MainWindow", "\u547d\u4e2d\u7684\u6587\u4ef6", None))
...
#if QT_CONFIG(tooltip)
        self.rescan_btn.setToolTip(QCoreApplication.translate("MainWindow", "\u8fd4\u56de\u914d\u7f6e\u9875\u91cd\u65b0\u626b\u63cf", None))
#endif // QT_CONFIG(tooltip)
        self.rescan_btn.setText(QCoreApplication.translate("MainWindow", "\u91cd\u65b0\u626b\u63cf", None))
#if QT_CONFIG(tooltip)
        self.export_btn.setToolTip(QCoreApplication.translate("MainWindow", "\u5bfc\u51fa\u626b\u63cf\u7ed3\u679c\u5230\u6587\u4ef6", None))
#endif // QT_CONFIG(tooltip)
        self.export_btn.setText(QCoreApplication.translate("MainWindow", "\u5bfc\u51fa\u7ed3\u679c", None))
        self.path_filter_input.setPlaceholderText(QCoreApplication.translate("MainWindow", "\u6309\u8def\u5f84\u7b5b\u9009...", None))
#if QT_CONFIG(tooltip)
        self.rule_filter_combo.setToolTip(QCoreApplication.translate("MainWindow", "\u6309\u89c4\u5219\u7b5b\u9009", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.group_mode_combo.setToolTip(QCoreApplication.translate("MainWindow", "\u5206\u7ec4\u6a21\u5f0f", None))
#endif // QT_CONFIG(tooltip)
        self.detail_action_title_label.setText(QCoreApplication.translate("MainWindow", "\u8be6\u60c5\u64cd\u4f5c:", None))
        self.detail_action_hint.setText(QCoreApplication.translate("MainWindow", "\u672a\u9009\u4e2d\u4efb\u4f55\u9879", None))
#if QT_CONFIG(tooltip)
        self.detail_prev_btn.setToolTip(QCoreApplication.translate("MainWindow", "\u8df3\u8f6c\u5230\u4e0a\u4e00\u4e2a\u547d\u4e2d\u4f4d\u7f6e", None))
#endif // QT_CONFIG(tooltip)
        self.detail_prev_btn.setText(QCoreApplication.translate("MainWindow", "\u4e0a\u4e00\u6761", None))
#if QT_CONFIG(tooltip)
        self.detail_next_btn.setToolTip(QCoreApplication.translate("MainWindow", "\u8df3\u8f6c\u5230\u4e0b\u4e00\u4e2a\u547d\u4e2d\u4f4d\u7f6e", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.detail_open_location_btn.setToolTip(QCoreApplication.translate("MainWindow", "\u5728\u6587\u4ef6\u7ba1\u7406\u5668\u4e2d\u6253\u5f00\u6240\u5728\u76ee\u5f55", None))
#endif // QT_CONFIG(tooltip)
        self.detail_open_location_btn.setText(QCoreApplication.translate("MainWindow", "\u6253\u5f00\u6587\u4ef6\u4f4d\u7f6e", None))
        self.detail_empty_hint.setText(QCoreApplication.translate("MainWindow", "\u672a\u9009\u4e2d\u4efb\u4f55\u9879\n"
"\u8bf7\u9009\u62e9\u5de6\u4fa7\u7ed3\u679c\u9879\u67e5\u770b\u8be6\u60c5", None))
        self.detail_hits_title_label.setText(QCoreApplication.translate("MainWindow", "\u547d\u4e2d\u89c4\u5219:", None))
        ...
        self.detail_preview_title_label.setText(QCoreApplication.translate("MainWindow", "\u5185\u5bb9\u9884\u89c8 (\u5173\u952e\u8bcd\u9ad8\u4eae):", None))
        self.note_edit.setPlaceholderText(QCoreApplication.translate("MainWindow", "\u5907\u6ce8/\u6279\u6ce8/\u5bfc\u51fa\u8bf4\u660e...", None))
...
#if QT_CONFIG(tooltip)
        self.edit_rule_btn.setToolTip(QCoreApplication.translate("MainWindow", "\u7f16\u8f91\u9009\u4e2d\u7684\u89c4\u5219\u6587\u4ef6", None))
#endif // QT_CONFIG(tooltip)
        self.edit_rule_btn.setText(QCoreApplication.translate("MainWindow", "\u7f16\u8f91", None))
        self.rules_file_label.setText(QCoreApplication.translate("MainWindow", "\u89c4\u5219\u6587\u4ef6\uff08\u987a\u5e8f\u4ece\u4e0a\u5230\u4e0b\uff0c\u540e\u8005\u8986\u76d6\u524d\u8005\uff09", None))
#if QT_CONFIG(tooltip)
        self.rules_file_list.setToolTip(QCoreApplication.translate("MainWindow", "\u5df2\u52a0\u8f7d\u7684\u89c4\u5219\u6587\u4ef6\uff0c\u5217\u8868\u987a\u5e8f\u4ee3\u8868\u4f18\u5148\u7ea7\uff08\u4ece\u4f4e\u5230\u9ad8\uff09", None))
#endif // QT_CONFIG(tooltip)
        ___qtreewidgetitem = self.rules_tree.headerItem()
        ___qtreewidgetitem.setText(2, QCoreApplication.translate("MainWindow", "\u6269\u5c55\u540d", None))
        ___qtreewidgetitem.setText(1, QCoreApplication.translate("MainWindow", "\u4e25\u91cd\u7b49\u7ea7", None))
        ___qtreewidgetitem.setText(0, QCoreApplication.translate("MainWindow", "\u89c4\u5219\u540d", None))
        self.history_label.setText(QCoreApplication.translate("MainWindow", "\u626b\u63cf\u5386\u53f2\uff08\u53cc\u51fb\u5feb\u901f\u9009\u62e9\uff09", None))
#if QT_CONFIG(tooltip)
        self.history_list.setToolTip(QCoreApplication.translate("MainWindow", "\u6700\u8fd1\u626b\u63cf\u8fc7\u7684\u8def\u5f84\uff0c\u53cc\u51fb\u53ef\u5feb\u901f\u9009\u62e9", None))
#endif // QT_CONFIG(tooltip)
