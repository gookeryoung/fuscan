...
from pyfilescan.archive.base import (
    ArchiveEntry,
    ArchiveError,
    ArchiveReader,
...
from pyfilescan.archive.rar_reader import RarReader
from pyfilescan.archive.zip_reader import ZipReader
...
# 延迟导入避免循环依赖
from pyfilescan.archive.scanner import ArchiveScanner  # noqa: E402
